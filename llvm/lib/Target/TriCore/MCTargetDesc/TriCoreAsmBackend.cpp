...
public:
  ...
  void applyFixup(const MCFragment &Fragment, const MCFixup &Fixup,
                          ...
                          uint64_t Value, bool IsResolvedvk) override;
...
void TriCoreAsmBackend::applyFixup(const MCFragment &Fragment, const MCFixup &Fixup,
                          const MCValue &Target, MutableArrayRef<char> Data,
                          uint64_t Value, bool IsResolvedvk)
{
  unsigned NumBytes = 4;
